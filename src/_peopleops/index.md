...
All verifications of employment (VOE’s) should go through the Human Resource department. These include but are not limited to requests from government agencies, mortgage lenders, prospective employers and others. 

Meltano will comply with all government requests for verification of employment. 

Meltano will respond to requests from mortgage lenders, landlords and the like, if the request is accompanied by a release form from the employee. Additionally, employees should notify Human Resources that a request may be forthcoming. 
