...
1. All meetings should have an agenda. Use the "Create Meeting Notes" feature in Google Calendar to quickly create a Google Doc that is shared with all users invited to the event. Update the title of the doc to include the [ISO date](https://en.wikipedia.org/wiki/ISO_8601#Calendar_dates).

### Writing Style Guidelines

1. {: #american-english} At Meltano, we use American English as the standard written language.
