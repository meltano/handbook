...
To log time off, team members should use [PTO by Roots](/tech-stack/#pto-by-roots) in Slack (under Apps).
...
Meltano team members should mark these days off using [PTO by Roots](/tech-stack/#pto-by-roots).
