...
- Update the above-linked tracking spreadsheet to indicate the new acquisition.
- Make sure the name is registered to "Meltano Operations" if possible or the name of the CEO or other corporate officer if not.
- Use the [email addresses and other information in the tracking spreadsheet](https://docs.google.com/spreadsheets/d/15f_p0jU1ZaIMPE8_3OTBjM5Uf5_RjtG8EIRUygFVBTM/edit#gid=329645876) are used as contact information for the domain.
